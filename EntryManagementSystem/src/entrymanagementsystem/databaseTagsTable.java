...
/** Strongly typed access to the database table "tags".
 *
...
public class TagsTable
{
    ...
    {
        idColumnName , tagColumnName , countColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockTagsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( TagsTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( tagColumnName , this.tag );
            data.put( countColumnName , String.valueOf(  this.count ) );
            return data ;
        }
