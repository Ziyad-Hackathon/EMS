...
/** Strongly typed access to the database table "user".
 *
...
public class UserTable
{
    ...
    {
        idColumnName , nameColumnName , surnameColumnName , sexColumnName , dobColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockUserTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( UserTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( sexColumnName , this.sex );
