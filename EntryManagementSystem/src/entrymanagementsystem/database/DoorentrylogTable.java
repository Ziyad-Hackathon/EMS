...
/** Strongly typed access to the database table "doorentrylog".
 *
 ...
 *
 */
public class DoorentrylogTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "doorentrylog";

    public static final String idColumnName = "id";
    public static final String user_idColumnName = "user_id";
    public static final String doors_idColumnName = "doors_id";
    public static final String dateColumnName = "date";
    public static final String timeColumnName = "time";
    public static final String snapshotColumnName = "snapshot";

    private static String[] allColumns =
    {
        idColumnName , user_idColumnName , doors_idColumnName , dateColumnName , timeColumnName , snapshotColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockDoorentrylogTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( DoorentrylogTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    static class Implementation extends TableFacade
    {
        ...
        Implementation()
        {
            super( ziyadcou_hackathonFacade.getInstance() , tableName );
        }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.user_id =  Str.toInt( data[1] );
                this.doors_id =  Str.toInt( data[2] );
                this.date = data[3];
                this.time = data[4];
                this.snapshot = data[5];
        ...
        public void setDoors_id( int doors_id )
        {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( user_idColumnName , String.valueOf(  this.user_id ) );
            data.put( doors_idColumnName , String.valueOf(  this.doors_id ) );
            data.put( dateColumnName , this.date );
            data.put( timeColumnName , this.time );
            data.put( snapshotColumnName , this.snapshot );
            return data ;
        }
