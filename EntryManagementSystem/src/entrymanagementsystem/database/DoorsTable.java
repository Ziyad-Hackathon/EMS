...
/** Strongly typed access to the database table "doors".
 *
 ...
 *
 */
public class DoorsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "doors";
    ...
    {
        idColumnName , descriptionColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockDoorsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( DoorsTable.Implementation instance  )
    {
        imp = instance ;
    }
