...
public class ziyadcou_hackathonFacade
{
    ...
    public static class Implementation extends DBFacade
    {
        ...
        Implementation()
        {
            super("com.mysql.jdbc.Driver" , "jdbc:mysql://74.52.115.34:3306/ziyadcou_hackathon" , "ziyadcou_stefan" , "7XbimGA5nA0W");
        }
    ...
    private ziyadcou_hackathonFacade()
    {
    }
