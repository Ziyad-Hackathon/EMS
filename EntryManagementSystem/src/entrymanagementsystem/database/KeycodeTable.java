...
/** Strongly typed access to the database table "keycode".
 *
...
public class KeycodeTable
{
    ...
    public static final String tableName = "keycode";

    public static final String codeColumnName = "code";
    public static final String user_idColumnName = "user_id";
    public static final String swipecodeColumnName = "swipecode";
    public static final String scancodeColumnName = "scancode";

    private static String[] allColumns =
    {
        codeColumnName , user_idColumnName , swipecodeColumnName , scancodeColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockKeycodeTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( KeycodeTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.swipecode = data[2];
                this.scancode = data[3];
        ...
        private Map buildDataMap()
        {
            ...
            data.put( swipecodeColumnName , this.swipecode );
            data.put( scancodeColumnName , this.scancode );
            return data ;
        }
