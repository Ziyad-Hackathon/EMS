...
/** Strongly typed access to the database table "user_interests".
 *
 ...
 *
 */
public class User_interestsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "user_interests";

    public static final String user_idColumnName = "user_id";
    public static final String tagsColumnName = "tags";
    public static final String likedColumnName = "liked";
    public static final String dislikedColumnName = "disliked";

    private static String[] allColumns =
    {
        user_idColumnName , tagsColumnName , likedColumnName , dislikedColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockUser_interestsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( User_interestsTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                this.user_id =  Str.toInt( data[0] );
                this.tags = data[1];
                this.liked = data[2];
                this.disliked = data[3];
        ...
        private Map buildDataMap()
        {
            ...
            data.put( likedColumnName , this.liked );
            data.put( dislikedColumnName , this.disliked );
            return data ;
        }
