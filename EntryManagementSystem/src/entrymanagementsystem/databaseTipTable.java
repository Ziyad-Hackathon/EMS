...
/** Strongly typed access to the database table "tip".
 *
...
public class TipTable
{
    ...
    public static final String tipColumnName = "tip";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockTipTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( TipTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( tipColumnName , this.tip );
            return data ;
        }
