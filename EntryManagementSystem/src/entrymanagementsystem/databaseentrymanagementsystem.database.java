...
public class entrymanagementsystem.database
{
    ...
    public static class Implementation extends DBFacade
    {
        ...
        Implementation()
        {
            super("com.mysql.jdbc.Driver" , "jdbc:mysql://ramen.cs.man.ac.uk:3306/11_COMP10120_D1" , "11_COMP10120_D1" , "ztDsBWSMqDny80BR");
        }
    ...
    private entrymanagementsystem.database()
    {
    }
