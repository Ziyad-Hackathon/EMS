...
/** Strongly typed access to the database table "comments".
 *
...
public class CommentsTable
{
    ...
    public static final String suggestion_idColumnName = "suggestion_id";
    ...
    {
        idColumnName , suggestion_idColumnName , usernameColumnName , contentColumnName , timeColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockCommentsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( CommentsTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.suggestion_id =  Str.toInt( data[1] );
        ...
        private Map buildDataMap()
        {
            ...
            data.put( suggestion_idColumnName , String.valueOf(  this.suggestion_id ) );
